...
<section class="row new-post">
    <div class="col-md-3 col-sm-12">
        ...
        <h6>@<span>{{ $user->username }}</span></h6>-->--}} {{-- <img src='{{Auth::user()->avatar}}' class='img-responsive' alt='Profile picture'> --}}
                ...
                <p class="des">Profession<br> 25,&nbspMale
                    <br> California
                    <br>
                    <strong>Bio</strong> <br> tghhehhehhhhdh
                </p>
    ...
    <div class="col-md-9 col-sm-12">
        ...
        <form action="{{ route('account.save') }}" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="first_name">First Name</label>
                <input type="text" name="first_name" class="form-control" value={{$first_name}} id="first_name">
            </div>
            <div class="form-group">
                <label for="last_name">Last Name</label>
                <input type="text" name="last_name" class="form-control" value={{$last_name}} id="last_name">
            </div>
            <div class="form-group">
                <label for="email">Email</label>
...
<section class="row new-post">
    <div class="col-md-6 col-md-offset-3"> --}} {{-- <img src="{{ route('account.image', ['filename' => $user->first_name . '-' . $user->id . '.jpg']) }}" alt=""
            class="img-responsive" style="height:200px;"> --}} {{-- </div>
</section>
@endif --}}
@endsection